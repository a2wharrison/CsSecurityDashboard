...
<ul id="navlist">
	...
	<g:if test="${menuitem!=null && menuitem=='listRoles'}">
		<li class="active"><g:link controller="dashboard" action="listUsersRoles">List Roles</g:link></li>
	</g:if>
	<g:else>
		<li><g:link controller="dashboard" action="listUsersRoles">List Roles</g:link></li>
	</g:else>
